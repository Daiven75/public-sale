...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3433982846570298221L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"avro.kafka.model\",\"fields\":[{\"name\":\"code\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Product(java.lang.String code, java.lang.String name) {
    this.code = code;
    this.name = name;
  }
   ...
   */
  public static avro.kafka.model.Product.Builder newBuilder() {
    return new avro.kafka.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static avro.kafka.model.Product.Builder newBuilder(avro.kafka.model.Product.Builder other) {
    if (other == null) {
      return new avro.kafka.model.Product.Builder();
    } else {
      return new avro.kafka.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static avro.kafka.model.Product.Builder newBuilder(avro.kafka.model.Product other) {
    if (other == null) {
      return new avro.kafka.model.Product.Builder();
    } else {
      return new avro.kafka.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.kafka.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.kafka.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.code)) {
        this.code = data().deepCopy(fields()[0].schema(), other.code);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.kafka.model.Product.Builder setCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.kafka.model.Product.Builder clearCode() {
      code = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.kafka.model.Product.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.kafka.model.Product.Builder clearName() {
      name = null;
