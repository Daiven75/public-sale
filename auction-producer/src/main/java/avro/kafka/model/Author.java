...
public class Author extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9152156677710391094L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Author\",\"namespace\":\"avro.kafka.model\",\"fields\":[{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Author(java.lang.String name, java.lang.String email) {
    this.name = name;
    this.email = email;
  }
   ...
   */
  public static avro.kafka.model.Author.Builder newBuilder() {
    return new avro.kafka.model.Author.Builder();
  }
   ...
   * @return A new Author RecordBuilder
   */
  public static avro.kafka.model.Author.Builder newBuilder(avro.kafka.model.Author.Builder other) {
    if (other == null) {
      return new avro.kafka.model.Author.Builder();
    } else {
      return new avro.kafka.model.Author.Builder(other);
    }
  }
   ...
   * @return A new Author RecordBuilder
   */
  public static avro.kafka.model.Author.Builder newBuilder(avro.kafka.model.Author other) {
    if (other == null) {
      return new avro.kafka.model.Author.Builder();
    } else {
      return new avro.kafka.model.Author.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Author>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.kafka.model.Author.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.kafka.model.Author other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.kafka.model.Author.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.kafka.model.Author.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.kafka.model.Author.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.kafka.model.Author.Builder clearEmail() {
      email = null;
