package com.lucasilva.auctionproducer.avro;
...
public class Proposal extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static Proposal.Builder newBuilder() {
   ...
   * @return A new Proposal RecordBuilder
   */
  public static Proposal.Builder newBuilder(Proposal.Builder other) {
    if (other == null) {
      return new Proposal.Builder();
    } else {
      return new Proposal.Builder(other);
    }
  }
   ...
   * @return A new Proposal RecordBuilder
   */
  public static Proposal.Builder newBuilder(Proposal other) {
    if (other == null) {
      return new Proposal.Builder();
    } else {
      return new Proposal.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Proposal>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Proposal.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Proposal other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.product)) {
        this.product = data().deepCopy(fields()[0].schema(), other.product);
    ...
    /**
      ...
      * @return This builder.
      */
    public Proposal.Builder setProduct(Product value) {
    ...
    public Proposal.Builder setProductBuilder(Product.Builder value) {
      clearProduct();
    ...
    /**
      ...
      * @return This builder.
      */
    public Proposal.Builder clearProduct() {
      product = null;
      productBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Proposal.Builder setAuthor(Author value) {
    ...
    public Proposal.Builder setAuthorBuilder(Author.Builder value) {
      clearAuthor();
      authorBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Proposal.Builder clearAuthor() {
      author = null;
      authorBuilder = null;
    ...
    public Proposal build() {
      try {
        ...
        if (authorBuilder != null) {
          ...
          record.author = fieldSetFlags()[2] ? this.author : (Author) defaultValue(fields()[2]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
